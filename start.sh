...
# Bot 1
tmux new-session -d -n bot1 "LD_LIBRARY_PATH=~/src/celt/lib/ ruby $HOME/src/mumble-ruby-pluginbot/pluginbot.rb --config=$HOME/src/bot1_conf.rb$DEBUG"

# Bot 2
#tmux new-session -d -n bot2 "LD_LIBRARY_PATH=~/src/celt/lib/ ruby $HOME/src/mumble-ruby-pluginbot/pluginbot.rb --config=$HOME/src/bot2_conf.rb$DEBUG"

# Bot 3
#tmux new-session -d -n bot3 "LD_LIBRARY_PATH=~/src/celt/lib/ ruby $HOME/src/mumble-ruby-pluginbot/pluginbot.rb --config=$HOME/src/bot3_conf.rb$DEBUG"
